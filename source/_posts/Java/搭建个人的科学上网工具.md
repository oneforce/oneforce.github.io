---
title: 搭建个人的科学上网工具
description: 使用aws+shadowsocks，科学上网，这个应该是最最详尽的说明了
...
![](/images/amazon_ecs1.png)

如果出现下图

![](/images/amazon_ecs2.png)

请耐心等待后台审核，我的在1个小时内就审核通过了。

如果出现了下面了界面，恭喜你，可以继续了

![](/images/amazon_ecs_pass.png)

### 启动虚拟机

访问[你的首页](https://console.aws.amazon.com/ec2/v2/home)，启动实例
![](/images/amazon_ecs_start_vm1.png)

这里需要自己注意下，请记住自己的区域，否则相关的EC服务你可能会找不到
![](/images/amazon_ecs_area.png)

#### 步骤 1: 选择一个 Amazon 系统映像(AMI)

注意，这里需要点选`仅免费套餐`,否则可能会学错扣费

![](/images/amazon_ecs_select_vm.png)

#### 步骤 2: 选择一个实例类型

注意绿色的字
![](/images/amazon_ecs_select_redhat642.png)


#### 步骤 3: 配置实例详细信息（默认）


![](/images/amazon_ecs_select_redhat64_disk.png)


#### 步骤 4: 添加存储（默认）

![](/images/amazon_ecs_select_redhat64_4.png)


#### 步骤 5: 添加标签（默认）

![](/images/amazon_ecs_select_redhat64_5.png)
...
![](/images/amazon_ecs_select_redhat64_6.png)
...
![](/images/amazon_ecs_select_redhat64_7.png)

这里会让你下载保存一个密钥文件，请妥善保管这个文件，它是登陆你的EC2的唯一凭证。

![](/images/amazon_ecs_create_scret.png)


**如果出现在下图，你的实例就启动好了**

![](/images/amazon_ecs_running.png)
...
android 客户端二维码 
![](/imgas/shadowsock_andorid_qr.png)

### 配置你的shadowsocks 客户端

![](/images/ss_client_config.png)

然后就可以用你的浏览器访问 [google](www.google.com)，看看是否可以正常工作了。
